...
builtinEnv =
  [ ("negate", Negate),
    ...
    ("someCrit", MetaAccess MKCrit ASome),
    ("allCrit", MetaAccess MKCrit AAll),
    ("anyCrit", MetaAccess MKCrit AAny),
    ("someFail", MetaAccess MKFail ASome),
    ("allFail", MetaAccess MKFail AAll),
    ("anyFail", MetaAccess MKFail AAny),
    ("someReroll", MetaAccess MKReroll ASome),
    ("allReroll", MetaAccess MKReroll AAll),
    ("anyReroll", MetaAccess MKReroll AAny),
    ("someExtra", MetaAccess MKExtra ASome),
    ("allExtra", MetaAccess MKExtra AAll),
    ("anyExtra", MetaAccess MKExtra AAny),
    ("critsOn", CritsOn),
    ("failsOn", FailsOn),
    ("highest", Highest),
    ("lowest", Lowest),
